...
function App() {
  ...
  return (
    <div className="min-h-screen md:flex">
      ...
      <div className="absolute top-32 left-[25%] transform -translate-x-1/2">
        <img src={cardFront} alt="bg front" className="" />
        <img src={cardLogo} alt="" className="absolute top-10 left-10" />
        <h1 className="absolute top-36 left-10 text-3xl text-white text-center w-[80%]">
          {card}
        </h1>
      ...
      <div className="absolute bottom-72 left-[30%] transform -translate-x-1/2">
        <img src={cardBack} alt="bg front" className="" />
        <h1 className="absolute top-[6.5rem] left-[21.5rem] text-xl text-white">{cvv}</h1>
      </div>
